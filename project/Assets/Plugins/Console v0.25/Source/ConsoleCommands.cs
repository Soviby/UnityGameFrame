...
namespace CC.Console
{
    public static class ConsoleCommands
    {
        ...
        public static void AddDefaultCommands()
        {
            ...
            AddCommand("Log", consoleLog, "Logs a message to the console");
            AddCommand("Help", printHelp, "Shows the help text of all available commands");
            // AddCommand("LogWarning", consoleLogWarning, "Logs a warning to the console");
            // AddCommand("LogError", consoleLogError, "Logs an error to the console");
